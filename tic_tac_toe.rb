...
class TTTGame
  ...
  def display_board(clear = true) # string interpolation calls Sqaure#to_s on objects
    system 'clear' if clear # if clear boolean is true, clears prior output after each move
